...
#### 7.5. [ROADMAP] Integração Web3 (SIWE)
- Suporte planejado para compatibilidade com carteiras externas (Metamask, etc.).
...
| :----- | :---------------------------------- | :------------------------------------------------ | :------- |
| `GET`  | `/api/core/identity/challenge/:u`   | Obtém nonce para handshake.                       | Open     |
| `POST` | `/api/core/identity/register`       | Registro via assinatura Ed25519.                  | AAL1     |
